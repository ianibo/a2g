 ...
 * @version $Id: ChoiceTypeInfo.java,v 1.1.1.1 2004/06/18 06:38:13 ibbo Exp $
 *
...
public class ChoiceTypeInfo extends TypeInfo
{
  ...
  public void createTypeClassFile()
  {
    ...
    try
    {
        ...
        log.fine("Create Class, package is "+parent.getModulePackageName()+"."+type_reference.replace('-','_'));
