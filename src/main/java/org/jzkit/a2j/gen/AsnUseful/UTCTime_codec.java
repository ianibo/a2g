...
public class UTCTime_codec extends base_codec
{
  public static UTCTime_codec me = null;
  private OctetString_codec i_octetstring_codec = OctetString_codec.getCodec();

  public synchronized static UTCTime_codec getCodec()
  {
    if ( me == null )
    {
      me = new UTCTime_codec();
    }
    return me;
  }
                          ...
                          String type_name) throws java.io.IOException
  {
    ...
    {
      sm.implicit_tag(i_octetstring_codec, retval != null ? retval.getBytes(sm.getCharsetEncoding()) : null,
                      0, 23, is_optional, "UTCTime");
    }
    else if ( sm.getDirection() == SerializationManager.DIRECTION_DECODE )
    {
      byte[] octet_str = (byte[]) sm.implicit_tag(i_octetstring_codec, null, 0, 23, is_optional, "UTCTime");
      if ( octet_str != null )
