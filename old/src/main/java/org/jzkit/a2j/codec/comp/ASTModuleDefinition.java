...
public class ASTModuleDefinition extends SimpleNode {
  ...
  public ASTModuleDefinition(AsnParser p, int id) {
    super(p, id);
    this.package_name = p.getPackageName();
    this.output_dir = p.getOutputDir();
  }

  public void pass1()
  {
    log.fine("    ASTModuleDefinition::pass1");
    ...
    info.registerModule(identifier.getModuleReference().module_ref,default_tagging_is_explicit,true, package_name,output_dir);
