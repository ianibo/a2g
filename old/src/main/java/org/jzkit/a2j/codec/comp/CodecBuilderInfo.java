 ...
 * @version $Id: CodecBuilderInfo.java,v 1.1.1.1 2004/06/18 06:38:13 ibbo Exp $
 *
...
public class CodecBuilderInfo
{
    ...
    public static String builtinTypeInfo[][] = {
        ...
        { "org.jzkit.a2j.codec.runtime.AsnBitString", null },         // Bitstring
        { null, null },                                           // SetOrSeq
        { "java.util.ArrayList",null },                              // SetOrSeq Of
        { null, null },                                           // Choice
        { null, null },                                           // Selection
        { null, null },                                           // Tagged
        { null, null },                                           // Any
        ...
        { "org.jzkit.a2j.codec.runtime.AsnNull", null } };            // Null
    ...
    public CodecBuilderInfo()
    {
      ...
      // bim.registerType( "SequenceOf", new BuiltinTypeInfo("SequenceOf", true, SerializationManager.UNIVERSAL, SerializationManager.SEQUENCEOF, false, null, "java.util.ArrayList", bim));
      bim.registerType( "SetOrSequenceOf", new BuiltinTypeInfo("SetOrSequenceOf", true, SerializationManager.UNIVERSAL, SerializationManager.SEQUENCEOF, false, null, "java.util.ArrayList", bim));
      ...
      bim.registerType( "NULL", new BuiltinTypeInfo("NULL", true, SerializationManager.UNIVERSAL, SerializationManager.NULL, false, null, "org.jzkit.a2j.codec.runtime.AsnNull", bim));
                               ...
                               String output_dir)
    {
      ...
      if ( mi == null )
      {
          modules.put(module_reference, new ModuleInfo(module_reference,
    ...
    public void registerImport(String module_reference, String type_reference)
    {
      ...
      log.fine("Registering import of "+module_reference+"."+type_reference+" in module "+getCurrentModuleName());
        ...
        switch ( bit.which )
        {
          ...
          case 3:  // SetOrSequenceOf <<type>>
            ...
            else
            {
              ...
              // We create a custom codec, but the base type is ArrayList
