...
public class ObjectDescriptor_codec extends base_codec
{
  public static ObjectDescriptor_codec me = null;
  private OctetString_codec i_octetstring_codec = OctetString_codec.getCodec();


  public synchronized static ObjectDescriptor_codec getCodec()
  {
    if ( me == null )
    {
      me = new ObjectDescriptor_codec();
    }
    return me;
  }
                          ...
                          String type_name) throws java.io.IOException
  {
    ...
    if ( sm.getDirection() == SerializationManager.DIRECTION_ENCODE )
    {
      sm.implicit_tag(i_octetstring_codec, 
                      ...
                      0, 7, is_optional, "ObjectDescriptor");
    }
    else if ( sm.getDirection() == SerializationManager.DIRECTION_DECODE )
    {
      byte[] octet_str = (byte[]) sm.implicit_tag(i_octetstring_codec, null, 0, 7, is_optional, "ObjectDescriptor");
      if ( octet_str != null )
